...
const quests = [
    ...
    { id: "q3", name: "洞穴探险家", desc: "在洞穴击败10只怪物", target: 10, progress: 0, reward: { gold: 200, crit: 3 }, zone: 1, completed: false },
    { id: "q4", name: "屠龙勇士", desc: "击败巨龙", target: 1, progress: 0, reward: { gold: 1000, atk: 10, def: 10 }, zone: 2, completed: false, isBossQuest: true },
    { id: "q5", name: "富甲一方", desc: "拥有500金币", target: 500, progress: 0, reward: { exp: 300 }, isGoldQuest: true },
    { id: "q6", name: "连胜达人", desc: "连续击败3只怪物不逃跑", target: 3, progress: 0, reward: { dodge: 5, hp: 30 }, zone: -1, completed: false }
];
...
const achievements = [
    ...
    { id: "a3", name: "洞穴征服者", desc: "在洞穴击败20只怪物", condition: function(p) { return (p.zoneKills || {})[1] >= 20; }, reward: { exp: 500 }, unlocked: false },
    { id: "a4", name: "屠龙者", desc: "击败巨龙", condition: function(p) { return p.bossDefeated >= 1; }, reward: { gold: 500, atk: 10 }, unlocked: false },
    { id: "a5", name: "万元户", desc: "累计获得1000金币", condition: function(p) { return p.totalGoldEarned >= 1000; }, reward: { exp: 500 }, unlocked: false },
    { id: "a6", name: "事件达人", desc: "触发20次随机事件", condition: function(p) { return p.eventCount >= 20; }, reward: { gold: 100 }, unlocked: false },
    { id: "a7", name: "任务完成者", desc: "完成10个任务", condition: function(p) { return p.questCompleted >= 10; }, reward: { exp: 1000 }, unlocked: false },
    { id: "a8", name: "升级达人", desc: "达到20级", condition: function(p) { return p.lv >= 20; }, reward: { atk: 15, def: 15 }, unlocked: false }
];
